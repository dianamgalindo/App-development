...
struct communityPage: View {
    var communityData: Communities //data from communitiesPageData
    
    //Follow button variables
    @State var followBtn: String = "Follow"
    @State var followImg: String = "person.badge.plus"
        ...
        ScrollView {
            VStack (alignment: .leading){
                ...
                VStack (alignment: .leading) {
                        ...
                        HStack (alignment: .top) {
                            ...
                            VStack (alignment: .leading){
                                ...
                                HStack {
                                    ...
                                    Text(communityData.keyword)
                                        .font(.custom("Rubik-SemiBold", size: 15))
                                        .frame(width: 90, height: 30)
                                        .background(.white)
                                        .clipShape(Capsule())
                                    
                                    Text(communityData.keywordTwo)
                                        .font(.custom("Rubik-SemiBold", size: 15))
                                ...
                                HStack {
                                    ...
                                    Text(communityData.keywordThree)
                                        .font(.custom("Rubik-SemiBold", size: 15))
                                        .frame(width: 110, height: 30)
                                        .background(.white)
                                        .clipShape(Capsule())
                                    
                                    Text(communityData.keywordFour)
                                        .font(.custom("Rubik-SemiBold", size: 15))
                                        .frame(width: 110, height: 30)
                                        .background(.white)
                                        .clipShape(Capsule())
                    ...
                    Button{
                        followBtn = "Following"
                        followImg = "person.fill.checkmark"
                        followOffset = 40
                    ...
                    VStack (alignment: .leading){
                        ...
                        ScrollView(.horizontal, showsIndicators: true) {
                            HStack{
                                VStack(alignment: .leading){
                                    //Community Logo
                                    Image(communityData.memberImage)
                                        .renderingMode(.original)
                                        .resizable()
                                        .frame(width:110, height: 110)
                                        .cornerRadius(10)
                                        .shadow(
                                            ...
                                            x:0,
                                            y:0)
                                    Text(communityData.memberName)
                                        .font(.custom("Roboto-Regular", size: 16))
                                  
                                    Text(communityData.memberRole)
                                        .font(.custom("Roboto-Regular", size: 14))
                                }
                                VStack(alignment: .leading){
                                    Image(communityData.memberImageTwo)
                                        .renderingMode(.original)
                                        .resizable()
                                        .frame(width:110, height: 110)
                                        .cornerRadius(10)
                                        .shadow(
                                            ...
                                            x:0,
                                            y:0)
                                    Text(communityData.memberNameTwo)
                                        .font(.custom("Roboto-Regular", size: 16))
                                    Text(communityData.memberRoleTwo)
                                        .font(.custom("Roboto-Regular", size: 14))
                                }
                                VStack(alignment: .leading){
                                    Image(communityData.memberImageThree)
                                        .renderingMode(.original)
                                        .resizable()
                                        .frame(width:110, height: 110)
                                        .cornerRadius(10)
                                        .shadow(
                                            ...
                                            x:0,
                                            y:0)
                                    Text(communityData.memberNameThree)
                                        .font(.custom("Roboto-Regular", size: 16))
                                    Text(communityData.memberRoleThree)
                                        .font(.custom("Roboto-Regular", size: 14))
                                }
                                VStack(alignment: .leading){
                                    Image(communityData.memberImageFour)
                                        .renderingMode(.original)
                                        .resizable()
                                        .frame(width:110, height: 110)
                                        .cornerRadius(10)
                                        .shadow(
                                            ...
                                            x:0,
                                            y:0)
                                    Text(communityData.memberNameFour)
                                        .font(.custom("Roboto-Regular", size: 16))
                                    Text(communityData.memberRoleFour)
                                        .font(.custom("Roboto-Regular", size: 14))
                                }
...
struct communityPage_Previews: PreviewProvider {
    static var previews: some View {
        communityPage(communityData: communitiesSocietiesData[0]) //reading from my societies array
    }
}
